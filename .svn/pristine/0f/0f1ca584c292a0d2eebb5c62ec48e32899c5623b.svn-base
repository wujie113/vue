  ...
  <div class="app-container">
    <div class="filter-container"> 
      ...
      <el-table :data="list" row-key="id"  stripe style="width: 100%">
                <el-table-column prop="type" label="关注类型"/>
        <el-table-column prop="user.id" label="人员id"/>
        <el-table-column prop="bizId" label="河道"/>
  ...
  <el-dialog :visible.sync="visible" title="编辑">
  	<el-form :model="form">
			...
			<el-form-item label="人员id">
				<rm-user-select v-model="form.user.id"  />
			</el-form-item>
...
import { getList } from '@/api/res/focus.js'
