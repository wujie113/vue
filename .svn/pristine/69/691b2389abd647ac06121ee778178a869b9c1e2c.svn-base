<template>
  <div class="app-container">
    <div class="filter-container"> 
      ...
      fit
      highlight-current-row  row-key="id"  stripe style="width: 100%">
                <el-table-column prop="type" label="河流类型(沟渠、河流)"/>
...
import { getList } from '@/api/res/river.js'
