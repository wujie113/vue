...
export const cfg = {
    ...
    wfsServerUrl: 'http://117.40.230.32:10103/geoserver/zhhz/wfs',
    ...
    datalayers: [
        ...
        { id: 'shuizha', name: '水闸', code: "zhhz:resSluice", layer: {},zindex: 10, visible: false },
        { id: 'shuiyuandi', name: '水源地',code: "zhhz:resWatersource", layer: {},zindex: 11, visible: false },
        { id: 'shuiku', name: '水库',code: "zhhz:resReservoir", layer: {},zindex: 12, visible: false },
        { id: 'shuiku2', name: '水库2',code: "zhhz:shuiku",icon: 'shuiku', layer: {},zindex: 13, server: "http://47.107.32.58:8888/geoserver/zhhz/wms", visible: false },
        ...
        { id: 'paiwukou', name: '排污口',code: "zhhz:paishuikou", layer: {},zindex: 17, visible: false },
        ...
        { id: 'zerenduan', name: '责任段',code: "zhhz:zerenduan", type: 'wfs',layer: testZerenduanLayer,zindex: 21, visible: true }]
}
