<template>
	<div>
		...
		<el-table v-loading="listLoading" :data="list" row-key="id" stripe style="width: 100%;">
			...
			<el-table-column prop="lat" label="经度" :show-overflow-tooltip="true" />
			<el-table-column prop="lng" label="纬度" :show-overflow-tooltip="true" />
...
import { getList, get, save, del,getfiles } from '@/api/res/reservoir.js'
