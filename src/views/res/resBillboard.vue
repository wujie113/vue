<template>
  <div >
    <div class="filter-container"> 
       <el-input placeholder="检索公示牌名称、编码" v-model="query.search" style="width: 200px;" class="filter-item" @keyup.enter.native="handleFilter"/>
      
       <el-button  clearable  class="filter-item" type="primary" icon="el-icon-search" @click="handleFilter">查询</el-button>
      ...
      <el-table @current-change="handleCurrentChange" v-loading="listLoading" :data="list" row-key="id" border  stripe style="width: 100%">
        ...
        <el-table-column prop="column2" label="区级河长联系电话" :show-overflow-tooltip="true" min-width="350px"/>
        <el-table-column prop="column3" label="区级副河长" :show-overflow-tooltip="true" min-width="500px"/>
        <el-table-column prop="column4" label="区级副河长联系电话" :show-overflow-tooltip="true" min-width="400px"/>
        ...
        <el-table-column prop="column7" label="街道河长联系电话" :show-overflow-tooltip="true" min-width="250px"/>
        <el-table-column prop="column8" label="街道副河长" :show-overflow-tooltip="true" min-width="300px"/>
        <el-table-column prop="column9" label="街道副河长联系电话"  :show-overflow-tooltip="true" min-width="250px"/>
        <el-table-column prop="column10" label="社区河长" :show-overflow-tooltip="true" min-width="300px"/>
        <el-table-column prop="column11" label="社区河长联系电话" :show-overflow-tooltip="true" min-width="300px  "/>
        <el-table-column prop="column12" label="社区副河长" :show-overflow-tooltip="true" min-width="150px"/>
        <el-table-column prop="column13" label="社区副河长联系电话" :show-overflow-tooltip="true" min-width="150px"/>
        <el-table-column prop="column14" label="河流名称" :show-overflow-tooltip="true" min-width="150px"/>
        <el-table-column prop="column15" label="河道起讫点" :show-overflow-tooltip="true" min-width="150px"/>
        <el-table-column prop="column16" label="流域面积" :show-overflow-tooltip="true" min-width="150px"/>
        <el-table-column prop="column17" label="河道长度" :show-overflow-tooltip="true" min-width="150px"/>
        <el-table-column prop="column18" label="管理范围" :show-overflow-tooltip="true" min-width="250px"/>
        <el-table-column prop="column19" label="河长职责" :show-overflow-tooltip="true" min-width="500px"/>
        <el-table-column prop="column20" label="管护目标" :show-overflow-tooltip="true" min-width="600px"/>
        <el-table-column prop="column21" label="监督电话" :show-overflow-tooltip="true" min-width="400px"/>
        <el-table-column prop="column22" label="二级河长单位" :show-overflow-tooltip="true" min-width="300px"/>
        <el-table-column prop="column23" label="辖区河道起讫" :show-overflow-tooltip="true" min-width="400px"/>
        <el-table-column prop="column24" label="三级河段长单位" :show-overflow-tooltip="true" min-width="300px"/>
        <el-table-column prop="column25" label="辖区河段起讫" :show-overflow-tooltip="true" min-width="150px"/>
        <el-table-column prop="column26" label="一级河长" :show-overflow-tooltip="true" min-width="150px"/>
        <el-table-column prop="column27" label="二级河长" :show-overflow-tooltip="true" min-width="150px"/>
        <el-table-column prop="column28" label="副河长" :show-overflow-tooltip="true" min-width="150px"/>
        <el-table-column prop="column29" label="三级河段长" :show-overflow-tooltip="true" min-width="150px"/>
        <el-table-column prop="column30" label="管护要求" :show-overflow-tooltip="true" min-width="150px"/>
        <el-table-column prop="column31" label="保洁要求" :show-overflow-tooltip="true" min-width="150px"/>
        <el-table-column prop="column32" label="黑臭水体基本概况" :show-overflow-tooltip="true" min-width="150px"/>
        <el-table-column prop="column33" label="黑臭水体管护单位" :show-overflow-tooltip="true" min-width="150px"/>
        <el-table-column prop="column34" label="黑臭水体区级监管单位" :show-overflow-tooltip="true" min-width="150px"/>
        <el-table-column prop="column35" label="黑臭水体市级监管单位" :show-overflow-tooltip="true" min-width="150px"/>
 ...
 <el-dialog :visible.sync="v.formhistory" title="历史上传资源文件列表" width="60%" :append-to-body="false" :close-on-click-modal="false" :modal="false" :modal-append-to-body="false">
    ...
    <!--附件详情-->
    <el-dialog  :visible.sync="v.formenclosure" v-loading="v.enclosureLoading" title="附件详情" :append-to-body="false" :close-on-click-modal="false" :modal="false" :modal-append-to-body="false" width="30%">
           <el-form >
