<template>
  <div>
    <div class="filter-container">
      ...
      <el-button icon="el-icon-download" type="primary" @click="downloadExcel"
        >下载水闸数据模板</el-button
      >
      <el-button icon="el-icon-refresh" type="primary" @click="updateData"
        >更新水闸数据</el-button
      >
    </div>
    <el-table
    ...
    >
      ...
      <el-table-column
        prop="riverName"
        label="所在河流（湖、库、渠、海堤）名称"
        :show-overflow-tooltip="true"
        min-width="250"
      />
      <el-table-column
        prop="riverCode"
        label="所在河流（湖、库、渠、海堤）编码"
        :show-overflow-tooltip="true"
        min-width="250"
      />
      <el-table-column
      ...
      <el-table-column
        prop="coloum17"
        label="分(泄)洪闸过闸流量(立方米/秒)"
        :show-overflow-tooltip="true"
        min-width="220"
      />
      <el-table-column
        prop="coloum18"
        label="分(泄)洪闸设计洪水标准［重现期］（年）"
        :show-overflow-tooltip="true"
        min-width="330"
      />
      <el-table-column
        prop="coloum19"
        label="分(泄)洪闸校核洪水标准［重现期］（（年）"
        :show-overflow-tooltip="true"
        min-width="330"
      />
      <el-table-column
      ...
      <el-table-column
        prop="coloum21"
        label="节制闸设计洪水标准［重现期］（年）"
        :show-overflow-tooltip="true"
        min-width="280"
      />
      <el-table-column
        prop="coloum22"
        label="节制闸校核洪水标准［重现期］（年）"
        :show-overflow-tooltip="true"
        min-width="280"
      />
      <el-table-column
        prop="coloum23"
        label="排(退)水闸过闸流量(立方米/秒)"
        :show-overflow-tooltip="true"
        min-width="220"
      />
      <el-table-column
        prop="coloum24"
        label="排(退)水闸设计洪水标准［重现期］（年）"
        :show-overflow-tooltip="true"
        min-width="330"
      />
      <el-table-column
        prop="coloum25"
        label="排(退)水闸校核洪水标准［重现期］（年）"
        :show-overflow-tooltip="true"
        min-width="330"
      />
      <el-table-column
        prop="coloum26"
        label="排(退)水闸是否为引排双向闸"
        :show-overflow-tooltip="true"
        min-width="220"
      />
      <el-table-column
        prop="coloum27"
        label="引(进)水闸过闸流量(立方米/秒)"
        :show-overflow-tooltip="true"
        min-width="220"
      />
      <el-table-column
        prop="coloum28"
        label="引(进)水闸设计洪水标准［重现期］（年）"
        :show-overflow-tooltip="true"
        min-width="330"
      />
      <el-table-column
        prop="coloum29"
        label="引(进)水闸校核洪水标准［重现期］（年）"
        :show-overflow-tooltip="true"
        min-width="330"
      />
      <el-table-column
        prop="coloum30"
        label="引(进)水闸引水能力(万立方米)"
        :show-overflow-tooltip="true"
        min-width="220"
      />
      <el-table-column
        prop="coloum31"
        label="引(进)水闸引水用途供水对象"
        :show-overflow-tooltip="true"
        min-width="220"
      />
      <el-table-column
        prop="coloum32"
        label="引(进)水闸引水用途灌区名称"
        :show-overflow-tooltip="true"
        min-width="220"
      />
      <el-table-column
        prop="coloum33"
        label="引(进)水闸是否为引排双向闸"
        :show-overflow-tooltip="true"
        min-width="220"
      />
      <el-table-column
      ...
      <el-table-column
        prop="coloum35"
        label="挡潮闸设计潮水标准［重现期］（年）"
        :show-overflow-tooltip="true"
        min-width="330"
      />
      <el-table-column
        prop="coloum36"
        label="挡潮闸校核潮水标准［重现期］（年）"
        :show-overflow-tooltip="true"
        min-width="330"
      />
      <el-table-column
    ...
    >
      <div style="float:left">
        文件格式要求为： <span style="color:red">.xls</span>(Excel
        97-2018工作簿)
      </div>
      <br />
