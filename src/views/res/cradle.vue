<template>
  <div>
    <div class="filter-container">
      ...
      <el-upload :action="uploadaction" :show-file-list="false" :limit="1" accept=".xlsx,.xls" class="upload-demo" :before-upload="beforeUpload" :file-list="fileList" :data="uploaddata" :on-success="handleSuccess" :on-error="handlError">
    ...
    <el-table v-loading="listLoading" :data="list" row-key="id" stripe style="width: 100%" border>
