<template>
    <div class="demo"> 
        ...
        <ul class="list">
             <li><a href="javascript:;" @click="openLayer0">多窗口模式，层叠置顶</a></li> 
            <li><a href="javascript:;" @click="openLayer">1、最基本示例</a></li>
            <li><a href="javascript:;" @click="showLayer2=true">2、带有参数,高度百分比,确定取消按钮的弹层</a></li>
        ...
        <Layer title="最基本示例" v-model="showLayer" :maskLayer="false" :shade= "false">
        ...
        <Layer title="这是一个没标题栏的弹层" v-model="showLayer2"   :dialog="false" class="layer-1" width="500" :animation="2" :maskLayer="false" :shade= "false" height="50%" confirm="确定" cancel="取消">
            <p>这是一个没标题栏的弹层</p>
